...
export const App = () => {
    ...
    const openSessionFromLink = (sessionId, returnWorkspace = null) => openNotesTarget({ sessionId, view: "capture", returnWorkspace, status: "Opened linked session." });
