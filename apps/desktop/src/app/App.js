...
const SECONDARY_WORKSPACE_ITEMS = WORKSPACE_ITEMS.filter((item) => !["calendar", "notes", "now", "todos"].includes(item.id));
const SINGLE_PANE_WORKSPACES = ["todos", "time", "now", "analytics", "structure"];
const HIDE_SHARED_INSPECTOR_WORKSPACES = ["notes", "todos", "time", "analytics", "now", "structure"];
