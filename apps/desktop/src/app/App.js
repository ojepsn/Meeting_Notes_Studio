...
export const App = () => {
    const { snapshot, activeSessionId, activeView, saveState, lastSavedAt, isLoaded, loadError, load, setActiveSessionId, setActiveView, repository, saveSession, createNewSession, deleteSession, restoreSession, permanentlyDeleteSession, saveTodo, addTodo, deleteTodo, saveActivity, addActivity, deleteActivity, createCalendarEntryFromText, moveCalendarItem, convertTodoToActivity, ensureSessionForActivity, saveSettings, saveTemplate, resetTemplates, importLegacyBrowserData, saveAttachments, } = useDesktopStore();
