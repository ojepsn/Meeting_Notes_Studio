...
const normalizePromptProfile = (settings) => {
    ...
    return {
        ...
        meetingMinutesRules: migrateMeetingMinutesRules(typeof settings?.promptSettings?.generationRules === "string" && settings.promptSettings.generationRules.trim()
        ...
        translationRules: typeof settings?.promptSettings?.translationRules === "string" && settings.promptSettings.translationRules.trim()
