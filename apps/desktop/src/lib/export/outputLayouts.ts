...
const LEGACY_OUTPUT_LAYOUT_PRESET_MAP: Record<string, string> = {
...
export const isOutputLayoutPresetId = (value: string | undefined | null) =>
  Boolean(value && OUTPUT_LAYOUT_PRESETS.some((preset) => preset.id === value));

export const normalizeOutputLayoutPresetId = (value: string | undefined | null) => {
  if (!value) {
...
export const getOutputLayoutPreset = (presetId: string | undefined | null): OutputLayoutPreset =>
  OUTPUT_LAYOUT_PRESETS.find((preset) => preset.id === normalizeOutputLayoutPresetId(presetId))
