...
export type NoteSmithMcpToolName = "notesmith_search_sessions" | "notesmith_get_session" | "notesmith_search_calendar" | "notesmith_search_todos" | "notesmith_search_activities" | "notesmith_search_timelogs" | "notesmith_get_timelogs_by_date_range" | "notesmith_get_linked_context" | "notesmith_summarize_workspace";
