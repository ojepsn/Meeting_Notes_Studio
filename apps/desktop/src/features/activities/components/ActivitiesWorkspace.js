...
export const ActivitiesWorkspace = ({ activities, todos, timeLogs, structureOptions, linkedSessionStateByActivity, requestedActivityId, requestedDomain, requestedProject, onEditorClose, savedPeople, suggestedPeople, onToggle, onAdd, onAddChildTodo, onAddChildMeeting, onSave, onDelete, onCreateLinkedMeetingSession, onOpenSession, onPreviewSessionOutput, onOpenTodoDetail, onSaveTimeLog, onDeleteTimeLog, onStartTracking, onStopTracking, }) => {
    ...
    const runningActivities = useMemo(() => topLevelActivities.filter((activity) => Boolean(getRunningTimeLog(activityTimeLogsById.get(activity.id) || []))), [activityTimeLogsById, topLevelActivities]);
    useEffect(() => {
    ...
    return (_jsxs("div", { className: "card todos-workspace todos-workspace-minimal activities-hub-card", children: [_jsx("div", { className: "card-header session-editor-header-minimal", children: _jsxs("div", { children: [_jsx("h2", { children: "Activities" }), _jsx("p", { className: "muted", children: "This is the operational hub for existing activities. Create and organize activities in Structure, then run the work here." })] }) }), _jsxs("details", { className: "workspace-disclosure", children: [_jsx("summary", { children: "Quick add standalone activity" }), _jsxs("div", { className: "workspace-disclosure-body stack", children: [_jsx("p", { className: "tiny-text", children: "Use Structure for normal project-based setup. This quick add remains here for lightweight edge cases and cleanup work." }), _jsxs("div", { className: "todos-workspace-input-row", children: [_jsxs("div", { className: "field", children: [_jsx("label", { htmlFor: "activities-workspace-type", children: "Type" }), _jsxs("select", { id: "activities-workspace-type", value: draftType, onChange: (event) => setDraftType(event.target.value), children: [_jsx("option", { value: "task", children: "Task" }), _jsx("option", { value: "meeting", children: "Meeting" })] })] }), _jsxs("div", { className: "field field-wide", children: [_jsx("label", { htmlFor: "activities-workspace-draft", children: "New activity" }), _jsx("input", { id: "activities-workspace-draft", value: draft, onChange: (event) => setDraft(event.target.value), onKeyDown: (event) => {
                                                        ...
                                                        submitDraft();
                                                                ...
                                                                return runningLog
                                                                    ...
                                                                    : entry.actualTimeSpentMinutes
                                                                        ...
                                                                        : "No time";
                                                            })() })] })] }), _jsxs("div", { className: "activities-compact-item-actions", children: [_jsx("span", { className: "tiny-text", children: entry.dueDate || entry.doOn || entry.createdAt.slice(0, 10) }), _jsx("button", { className: `small-button${getRunningTimeLog(activityTimeLogsById.get(entry.id) || []) ? " primary-button" : ""}`, type: "button", onClick: (event) => {
                                                        event.stopPropagation();
