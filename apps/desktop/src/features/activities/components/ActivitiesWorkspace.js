...
export const ActivitiesWorkspace = ({ activities, linkedSessionIdsByActivity, requestedActivityId, onToggle, onAdd, onSave, onDelete, onCreateLinkedMeetingSession, onOpenSession, }) => {
