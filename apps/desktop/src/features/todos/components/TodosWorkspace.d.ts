...
export declare const TodosWorkspace: ({ todos, requestedTodoId, onEditorClose, onToggle, onAdd, onSave, onDelete, onConvertToActivity }: TodosWorkspaceProps) => import("react/jsx-runtime").JSX.Element;
export {};
