    ...
    const filteredTodos = useMemo(() => {
        ...
        const filtered = statusFiltered.filter((todo) => {
            ...
            if (!showBusinessTodos && !todo.isPrivate)
                return false;
            if (showPriorityOnly && getTodoPriority(todo) !== "high")
                return false;
                                                ...
                                                return (_jsxs("tr", { className: `${selectedTodoId === todo.id ? "todos-dense-row-selected" : ""}${todo.isDone ? " todos-dense-row-done" : ""}`, onClick: () => setSelectedTodoId(todo.id), onDoubleClick: () => openTodoDetail(todo.id), tabIndex: 0, onKeyDown: (event) => {
                                                        if (event.key === "Enter") {
                                                            ...
                                                            openTodoDetail(todo.id);
                                                                            ...
                                                                            event.stopPropagation();
                                                                            onToggle({ ...todo, isDone: !todo.isDone });
                                                                        } }), _jsxs("div", { className: "todos-dense-title-copy", children: [_jsx(DeferredTextInput, { className: "todos-inline-title-input", "aria-label": "Task title", value: todo.description, onClick: stopTableEditPropagation, onDoubleClick: stopTableEditPropagation, onKeyDown: stopTableEditPropagation, onCommit: (description) => saveTodoPatch(todo, { description }), placeholder: "Untitled task" }, `${todo.id}-description`), _jsx("span", { children: running ? `Running • ${elapsedLabel}` : totalMinutes ? formatTrackedMinutes(totalMinutes) : "No time logged" })] })] }) }), _jsx("td", { children: _jsx(DeferredTextInput, { className: "todos-inline-cell-input", "aria-label": "Task domain", value: todo.domain, onClick: stopTableEditPropagation, onDoubleClick: stopTableEditPropagation, onKeyDown: stopTableEditPropagation, onCommit: (domain) => saveTodoPatch(todo, { domain }), placeholder: "Domain" }, `${todo.id}-domain`) }), _jsx("td", { children: _jsx(DeferredTextInput, { className: "todos-inline-cell-input", "aria-label": "Task project", value: todo.project, onClick: stopTableEditPropagation, onDoubleClick: stopTableEditPropagation, onKeyDown: stopTableEditPropagation, onCommit: (project) => saveTodoPatch(todo, { project }), placeholder: "Project" }, `${todo.id}-project`) }), _jsx("td", { children: _jsx(DeferredTextInput, { className: "todos-inline-cell-input", "aria-label": "Task activity", value: activityLabel, onClick: stopTableEditPropagation, onDoubleClick: stopTableEditPropagation, onKeyDown: stopTableEditPropagation, onCommit: (activity) => saveTodoPatch(todo, { activity, activityId: "" }), placeholder: "Activity" }, `${todo.id}-activity`) }), _jsx("td", { children: _jsx(DateInput, { id: `todo-dense-do-on-${todo.id}`, className: "todos-inline-date-input", "aria-label": "Task do on date", value: doOnLabel, onClick: stopTableEditPropagation, onDoubleClick: stopTableEditPropagation, onKeyDown: stopTableEditPropagation, onChange: (event) => saveTodoPatch(todo, { doOn: event.target.value }) }) }), _jsx("td", { children: _jsx(DateInput, { id: `todo-dense-due-${todo.id}`, className: "todos-inline-date-input", "aria-label": "Task due date", value: dueDateLabel, onClick: stopTableEditPropagation, onDoubleClick: stopTableEditPropagation, onKeyDown: stopTableEditPropagation, onChange: (event) => saveTodoPatch(todo, { dueDate: event.target.value }) }) }), _jsx("td", { children: _jsx("div", { className: "todos-dense-details-cell", children: _jsx(DeferredTextInput, { className: "todos-inline-cell-input", "aria-label": "Task details", value: detailsText, onClick: stopTableEditPropagation, onDoubleClick: stopTableEditPropagation, onKeyDown: stopTableEditPropagation, onCommit: (details) => saveTodoPatch(todo, { detailsHtml: textToDetailsHtml(details) }), placeholder: "No details" }, `${todo.id}-details`) }) }), _jsx("td", { children: _jsxs("div", { className: "todos-dense-actions-cell", children: [_jsx("button", { className: `small-button${running ? " primary-button" : ""}`, type: "button", onClick: (event) => {
                                                                            event.stopPropagation();
                                                                            if (running) {
