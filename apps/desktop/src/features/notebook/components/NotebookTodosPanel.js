                                            ...
                                            if (event.key === "Enter") {
                                                ...
                                                ["due", "Due date"],
                                                    ...
                                                    setPriorityFilter("all");
                                                        ...
                                                        }, children: [_jsx("option", { value: "low", children: "Low" }), _jsx("option", { value: "normal", children: "Normal" }), _jsx("option", { value: "high", children: "High" })] })] }), _jsxs("label", { children: [_jsx("span", { children: "Do on" }), _jsx(DateInput, { id: "notebook-todo-do-on", value: selectedTodo.doOn, onChange: (event) => saveSelected({ doOn: event.target.value }) })] }), _jsxs("label", { children: [_jsx("span", { children: "Due date" }), _jsx(DateInput, { id: "notebook-todo-due", value: selectedTodo.dueDate, onChange: (event) => saveSelected({ dueDate: event.target.value }) })] })] }), _jsxs("div", { className: "notebook-todo-context-grid", children: [_jsxs("label", { className: "notebook-todo-context-wide", children: [_jsx("span", { children: "Participants" }), _jsx("input", { value: selectedTodo.participantText || "", placeholder: "People involved", onChange: (event) => saveSelected({ participantText: event.target.value }) })] }), _jsxs("label", { children: [_jsx("span", { children: "Domain" }), _jsx("input", { value: selectedTodo.domain, onChange: (event) => saveSelected({ domain: event.target.value }) })] }), _jsxs("label", { children: [_jsx("span", { children: "Project" }), _jsx("input", { value: selectedTodo.project, onChange: (event) => saveSelected({ project: event.target.value }) })] }), _jsxs("label", { children: [_jsx("span", { children: "Activity" }), _jsx("input", { value: selectedTodo.activity, onChange: (event) => saveSelected({ activity: event.target.value }) })] })] }), _jsxs("div", { className: "field notebook-todo-details-field", children: [_jsx("label", { htmlFor: "notebook-todo-details", children: "Todo details" }), _jsx(TodoDetailsEditor, { id: "notebook-todo-details", compact: true, value: selectedTodo.detailsHtml, onChange: (detailsHtml) => saveSelected({ detailsHtml }) })] }), _jsxs("div", { className: "notebook-todo-record-meta", "aria-label": "Todo record information", children: [_jsxs("span", { children: ["Created ", new Date(selectedTodo.createdAt).toLocaleString()] }), _jsxs("span", { children: ["Updated ", new Date(selectedTodo.updatedAt || selectedTodo.createdAt).toLocaleString()] }), _jsxs("span", { children: [selectedTodo.sessionIds.length, " linked ", selectedTodo.sessionIds.length === 1 ? "note" : "notes"] })] })] })) : (_jsxs("div", { className: "notebook-todo-empty-editor", children: [_jsx("strong", { children: "Select a todo" }), _jsx("p", { children: "Its editable fields and rich-text details will open here." })] }))] })] })] }));
};
