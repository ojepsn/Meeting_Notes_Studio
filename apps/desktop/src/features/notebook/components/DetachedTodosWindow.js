...
export const DetachedTodosWindow = () => {
    ...
    return (_jsx("main", { className: "app-shell detached-todos-window", "data-theme": theme, children: _jsx("div", { className: "detached-todos-window-content", children: _jsx(NotebookTodosPanel, { todos: todos, onAddTodo: (description) => void sendTodosCommand({ type: "add", description }), onSaveTodo: (todo) => void sendTodosCommand({ type: "save", todo }), onDeleteTodo: (todoId) => void sendTodosCommand({ type: "delete", todoId }), onAddNote: (todoId) => void sendTodosCommand({ type: "add-note", todoId }), headerActions: (_jsx("div", { className: "notebook-todos-window-actions", children: _jsx("span", { className: "tiny-text", children: isConnected ? "Synced with NoteSmith" : "Connecting..." }) })) }) }) }));
};
