...
const allowedFontSizes = new Set(RICH_TEXT_FONT_SIZE_OPTIONS.map((option) => option.cssValue));
export const resolveSafeRichTextHref = (value) => {
...
export const normalizeRichTextInlineFormatting = (wrapper) => {
...
export const preserveAllowedRichTextStyles = (element) => {
...
export const normalizePastedRichTextHtml = (value) => {
...
export const applyRichTextFont = (editor, fontFamily) => {
    editor.focus();
    document.execCommand("fontName", false, fontFamily);
};
export const applyRichTextFontSize = (editor, commandValue) => {
    editor.focus();
