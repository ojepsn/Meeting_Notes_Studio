...
export const NowWorkspace = ({ todos, activities, timeLogs, calendarItems, settings, onToggleTodo, onStartTracking, onStopTracking, onOpenTodoDetail, onOpenActivityDetail, onOpenProject, onSaveSettings, }) => {
    ...
    const filteredRecentEntries = useMemo(() => {
        ...
        return recentEntries.filter((entry) => {
            const kindVisible = (entry.kind === "task" && showTasks) ||
    ...
    return (_jsxs("div", { className: "card now-workspace", children: [_jsx("section", { className: "sidebar-card now-running-card", children: runningLogSummary ? (_jsxs("div", { className: "now-running-inline", children: [_jsxs("div", { className: "now-running-inline-primary", children: [_jsx("span", { className: "now-pill-kicker", children: "Running now" }), _jsx("span", { className: "now-pill-kicker", children: runningLogSummary.kind === "meeting" ? "Meeting" : runningLogSummary.kind === "activity" ? "Activity" : "Task" }), _jsx("strong", { className: "now-running-title", children: runningLogSummary.title }), _jsx("div", { className: "now-running-inline-status", children: _jsxs("span", { className: "status-chip", children: ["Running - ", runningLogSummary.elapsedLabel] }) })] }), _jsxs("div", { className: "now-running-inline-details", children: [_jsxs("div", { className: "now-running-inline-detail", children: [_jsx("span", { children: "Domain" }), _jsx("strong", { children: runningLogSummary.domain })] }), _jsxs("div", { className: "now-running-inline-detail", children: [_jsx("span", { children: "Project" }), _jsx("strong", { children: runningLogSummary.project })] }), _jsxs("div", { className: "now-running-inline-detail", children: [_jsx("span", { children: "Activity" }), _jsx("strong", { children: runningLogSummary.activity })] }), _jsxs("div", { className: "now-running-inline-detail", children: [_jsx("span", { children: "Text" }), _jsx("strong", { children: runningLogSummary.title })] })] }), _jsxs("div", { className: "now-pill-actions", children: [_jsx("button", { className: "primary-button", type: "button", onClick: () => onStopTracking(runningLogSummary.targetType, runningLogSummary.targetId), children: "Stop" }), _jsx("button", { className: "shell-button", type: "button", onClick: () => {
