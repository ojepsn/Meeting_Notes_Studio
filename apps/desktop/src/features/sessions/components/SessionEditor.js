...
export const SessionEditor = ({ session, templates, attachments, isTranscribingAudio, onChange, onImportTranscript, onImportAudio, onImportImage, onTranscribeAudio, onRemoveAttachment, onUpdateAttachment, }) => {
    ...
    const hasCaptureContent = Boolean(session.manualNotes.trim() ||
