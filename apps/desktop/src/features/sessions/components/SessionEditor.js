...
export const SessionEditor = ({ session, templates, attachments, savedPeople, isTranscribingAudio, onChange, onImportTranscript, onImportAudio, onImportImage, onTranscribeAudio, onRemoveAttachment, onUpdateAttachment, }) => {
