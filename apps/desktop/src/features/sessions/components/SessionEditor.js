...
export const SessionEditor = ({ session, templates, attachments, savedPeople, suggestedPeople, savedProjects, suggestedProjects, savedDomains, suggestedDomains, savedActivities, suggestedActivities, savedTags, suggestedTags, isTranscribingAudio, recordingMode, isRecordingAudio, recordingStatusNote, onChange, onImportTranscript, onImportAudio, onImportImage, onTranscribeAudio, onChangeRecordingMode, onStartRecording, onStopRecording, onRemoveAttachment, onUpdateAttachment, }) => {
    ...
    return (_jsxs("div", { className: "card", children: [_jsx("div", { className: "card-header", children: _jsx("div", { children: _jsx("h2", { children: "Capture" }) }) }), _jsx("div", { className: "capture-mode-switch", children: Object.keys(CAPTURE_MODE_META).map((captureMode) => (_jsxs("button", { className: "capture-mode-card", "data-active": session.captureMode === captureMode, type: "button", onClick: () => switchMode(captureMode), children: [_jsx("strong", { children: CAPTURE_MODE_META[captureMode].label }), _jsx("span", { children: CAPTURE_MODE_META[captureMode].subtitle })] }, captureMode))) }), _jsxs("div", { className: "form-grid", children: [_jsxs("div", { className: "capture-top-row field field-wide", children: [_jsxs("div", { className: "field capture-template-field", children: [_jsx("label", { htmlFor: "template-select", children: "Template" }), _jsx("select", { id: "template-select", value: activeTemplate?.id ?? "", onChange: (event) => handleTemplateChange(event.target.value), children: primaryTemplateOptions.map((template) => (_jsx("option", { value: template.id, children: template.name }, template.id))) })] }), _jsxs("div", { className: "field capture-title-field", children: [_jsx("label", { htmlFor: "session-title", children: "Title" }), _jsx("input", { id: "session-title", value: session.title, onChange: (event) => update("title", event.target.value), placeholder: session.captureMode === "meeting-note"
                                            ? "Weekly project meeting"
                                            : session.captureMode === "voice-note"
                                                ? "Voice memo"
                                                : "Quick note title" })] }), _jsxs("div", { className: "field capture-private-field", children: [_jsx("span", { children: "Private" }), _jsxs("div", { className: "compact-private-toggle", children: [_jsx("input", { id: "session-private", type: "checkbox", checked: session.isPrivate, onChange: (event) => update("isPrivate", event.target.checked) }), _jsx("label", { htmlFor: "session-private", className: "checkbox-label", children: "Private" })] }), _jsx("span", { className: "tiny-text", children: "Hide from public-only views." })] })] }), showMeetingMeta ? (_jsxs("details", { className: "field field-wide workspace-disclosure", children: [_jsx("summary", { children: "Meeting details" }), _jsxs("div", { className: "workspace-disclosure-body form-grid", children: [_jsxs("div", { className: "field", children: [_jsx("label", { htmlFor: "session-date", children: "Date" }), _jsx("input", { id: "session-date", type: "date", value: session.date, onChange: (event) => update("date", event.target.value) })] }), _jsxs("div", { className: "field", children: [_jsx("label", { htmlFor: "session-participants", children: "People" }), _jsx(PeoplePicker, { value: session.participantText, savedPeople: savedPeople, suggestedPeople: suggestedPeople, onChange: (value) => update("participantText", value), placeholder: "Search or add people" })] }), _jsx("div", { className: "field field-wide metadata-triplet", children: _jsxs("div", { className: "metadata-triplet-grid", children: [_jsxs("div", { className: "field metadata-subfield", children: [_jsx("label", { htmlFor: "session-domain", children: "Domain" }), _jsx(TokenPicker, { value: session.domain, savedOptions: savedDomains, suggestedOptions: suggestedDomains, placeholder: "Search or add domain", helperText: "Use Domain for the top-level business area behind this note. New values stay in this note and can be saved for reuse after Output is created.", suggestionSummary: "Recent domains", suggestionBadgeText: "From saved Domains", mode: "single", onChange: (value) => update("domain", value) })] }), _jsxs("div", { className: "field metadata-subfield", children: [_jsx("label", { htmlFor: "session-project", children: "Project" }), _jsx(TokenPicker, { value: session.project, savedOptions: savedProjects, suggestedOptions: suggestedProjects, placeholder: "Search or add project", helperText: "Use Project for work you expect to sort and revisit often. New values stay in this note and can be saved for reuse after Output is created.", suggestionSummary: "Recent projects", suggestionBadgeText: "From saved Projects", mode: "single", onChange: (value) => update("project", value) })] }), _jsxs("div", { className: "field metadata-subfield", children: [_jsx("label", { htmlFor: "session-activity", children: "Activity" }), _jsx(TokenPicker, { value: session.activity, savedOptions: savedActivities, suggestedOptions: suggestedActivities, placeholder: "Search or add activity", helperText: "Use Activity for the concrete stream of work inside the project or domain. New values stay in this note and can be saved for reuse after Output is created.", suggestionSummary: "Recent activities", suggestionBadgeText: "From saved Activities", mode: "single", onChange: (value) => update("activity", value) })] })] }) }), _jsxs("div", { className: "field", children: [_jsx("label", { htmlFor: "session-start", children: "Start time" }), _jsx("input", { id: "session-start", type: "time", value: session.startTime, onChange: (event) => update("startTime", event.target.value) })] }), _jsxs("div", { className: "field", children: [_jsx("label", { htmlFor: "session-end", children: "End time" }), _jsx("input", { id: "session-end", type: "time", value: session.endTime, onChange: (event) => update("endTime", event.target.value) })] }), _jsxs("div", { className: "field field-wide", children: [_jsx("label", { htmlFor: "session-tags", children: "Tags" }), _jsx(TokenPicker, { value: session.tagsText, savedOptions: savedTags, suggestedOptions: suggestedTags, placeholder: "Add tags like q2-planning, budget, hiring", helperText: "Use Tags for flexible cross-cutting labels when Domain, Project, and Activity alone are not enough.", suggestionSummary: "Recent tags", suggestionBadgeText: "From saved Tags", onChange: (value) => update("tagsText", value) })] })] })] })) : (_jsxs("details", { className: "field field-wide workspace-disclosure", children: [_jsx("summary", { children: "Optional note details" }), _jsxs("div", { className: "workspace-disclosure-body form-grid", children: [_jsxs("div", { className: "field", children: [_jsx("label", { htmlFor: "session-date", children: "Date" }), _jsx("input", { id: "session-date", type: "date", value: session.date, onChange: (event) => update("date", event.target.value) })] }), _jsxs("div", { className: "field", children: [_jsx("label", { htmlFor: "session-time", children: "Time" }), _jsx("input", { id: "session-time", type: "time", value: session.startTime, onChange: (event) => update("startTime", event.target.value) })] }), _jsxs("div", { className: "field", children: [_jsx("label", { htmlFor: "session-participants", children: "People" }), _jsx(PeoplePicker, { value: session.participantText, savedPeople: savedPeople, suggestedPeople: suggestedPeople, onChange: (value) => update("participantText", value), placeholder: "Search or add optional context" })] }), _jsx("div", { className: "field field-wide metadata-triplet", children: _jsxs("div", { className: "metadata-triplet-grid", children: [_jsxs("div", { className: "field metadata-subfield", children: [_jsx("label", { htmlFor: "session-domain", children: "Domain" }), _jsx(TokenPicker, { value: session.domain, savedOptions: savedDomains, suggestedOptions: suggestedDomains, placeholder: "Search or add domain", suggestionSummary: "Recent domains", suggestionBadgeText: "From saved Domains", mode: "single", onChange: (value) => update("domain", value) })] }), _jsxs("div", { className: "field metadata-subfield", children: [_jsx("label", { htmlFor: "session-project", children: "Project" }), _jsx(TokenPicker, { value: session.project, savedOptions: savedProjects, suggestedOptions: suggestedProjects, placeholder: "Search or add project", helperText: "Optional, but useful when you want to group related notes later.", suggestionSummary: "Recent projects", suggestionBadgeText: "From saved Projects", mode: "single", onChange: (value) => update("project", value) })] }), _jsxs("div", { className: "field metadata-subfield", children: [_jsx("label", { htmlFor: "session-activity", children: "Activity" }), _jsx(TokenPicker, { value: session.activity, savedOptions: savedActivities, suggestedOptions: suggestedActivities, placeholder: "Search or add activity", suggestionSummary: "Recent activities", suggestionBadgeText: "From saved Activities", mode: "single", onChange: (value) => update("activity", value) })] })] }) }), _jsxs("div", { className: "field field-wide", children: [_jsx("label", { htmlFor: "session-tags", children: "Tags" }), _jsx(TokenPicker, { value: session.tagsText, savedOptions: savedTags, suggestedOptions: suggestedTags, placeholder: "Add tags like q2-planning, budget, hiring", helperText: "Use Tags for flexible labels that cut across domains, projects, activities, and note types.", suggestionSummary: "Recent tags", suggestionBadgeText: "From saved Tags", onChange: (value) => update("tagsText", value) })] })] })] })), session.captureMode === "voice-note" ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: "field field-wide", children: [_jsx("label", { htmlFor: "live-transcript", children: modeMeta.primaryFieldLabel }), _jsx("textarea", { id: "live-transcript", value: session.liveTranscript, onChange: (event) => update("liveTranscript", event.target.value), placeholder: modeMeta.primaryFieldPlaceholder })] }), _jsxs("details", { className: "field field-wide workspace-disclosure", children: [_jsx("summary", { children: "Optional written note" }), _jsx("div", { className: "workspace-disclosure-body", children: _jsxs("div", { className: "field field-wide", children: [_jsx("label", { htmlFor: "manual-notes", children: "Manual note" }), _jsx("textarea", { id: "manual-notes", value: session.manualNotes, onChange: (event) => update("manualNotes", event.target.value), placeholder: "Add a short written note if it helps later." })] }) })] })] })) : (_jsxs("div", { className: "field field-wide", children: [_jsx("label", { htmlFor: "manual-notes", children: modeMeta.primaryFieldLabel }), _jsx("textarea", { id: "manual-notes", value: session.manualNotes, onChange: (event) => update("manualNotes", event.target.value), placeholder: modeMeta.primaryFieldPlaceholder })] })), showQuickHighlights ? (_jsxs("div", { className: "field field-wide", children: [_jsx("label", { htmlFor: "quick-highlights", children: "Quick highlights" }), _jsx("textarea", { id: "quick-highlights", value: session.quickHighlights, onChange: (event) => update("quickHighlights", event.target.value), placeholder: "Short key points, names, or topics to emphasize in the final output." })] })) : null, customFields.map((field) => (_jsxs("div", { className: field.type === "textarea" ? "field field-wide" : "field", children: [_jsx("label", { htmlFor: `custom-field-${field.id}`, children: field.label }), field.type === "textarea" ? (_jsx("textarea", { id: `custom-field-${field.id}`, value: session.customFieldValues[field.id] ?? "", onChange: (event) => update("customFieldValues", {
