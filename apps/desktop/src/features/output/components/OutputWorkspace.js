...
export const OutputWorkspace = ({ session, template, displayedOutput = session.output, outputVersions = [], selectedOutputVersionId = null, attachments, presentation = "full", showPresentationActions = true, onChange, savedPeople, suggestedPeople, savedProjects, suggestedProjects, savedDomains, suggestedDomains, savedActivities, suggestedActivities, structureOptions, savedTags, suggestedTags, isPrimaryActionRunning, isSecondaryActionRunning, isRevising, onPrimaryAction, onSecondaryAction, onTranslate, onRevise, onOpenOutputVersion, onOpenLatestOutputVersion, onExportText, onExportMarkdown, onExportHtml, onExportDocx, onExportPdf, outputLanguage, primaryActionLabel = "Generate", secondaryActionLabel = null, emptyStatePrimaryLabel = "Generate polished notes", emptyStateSecondaryLabel = null, linkedActivity = null, onOpenLinkedActivity, onAddFollowUpTodo, onAddFollowUpMeeting, }) => {
    ...
    const outputLanguageLabel = outputLanguage === "sv" ? "Swedish" : outputLanguage === "en" ? "English" : "Same as source notes";
    ...
    if (isMinimal) {
        return (_jsxs("div", { className: "card output-workspace output-workspace-minimal output-workspace-pwa", children: [_jsx("div", { className: "panel-heading output-workspace-pwa-heading", children: _jsx("div", { className: "panel-heading-copy", children: _jsx("p", { className: "section-label", children: "Output" }) }) }), _jsx("div", { className: "panel-actions panel-actions-output-top output-actions-row-pwa", children: _jsxs("div", { className: "panel-actions-page", children: [_jsx("button", { className: "shell-button", type: "button", onClick: onExportDocx, children: "Export Word" }), _jsx("button", { className: "shell-button", type: "button", onClick: onExportPdf, children: "Export PDF" }), _jsx("button", { className: "shell-button", type: "button", onClick: onTranslate, children: "Translate" })] }) }), _jsxs("div", { className: "output-layout output-layout-pwa", children: [_jsx("aside", { className: "output-sidebar", children: _jsxs("section", { className: "config-card workflow-card output-workflow-card", "aria-label": "Generation controls", children: [_jsxs("div", { className: "config-card-copy", children: [_jsx("p", { className: "section-label", children: "Generate" }), _jsx("h3", { children: "Output actions" })] }), _jsxs("div", { className: "capture-toolbar capture-toolbar-sidebar", children: [_jsx("button", { className: "primary-button", type: "button", onClick: onPrimaryAction, children: isPrimaryActionRunning ? `${primaryActionLabel}...` : primaryActionLabel }), secondaryActionLabel && onSecondaryAction ? (_jsx("button", { className: "secondary-button", type: "button", onClick: onSecondaryAction, children: isSecondaryActionRunning ? `${secondaryActionLabel}...` : secondaryActionLabel })) : null] }), _jsxs("details", { className: "workspace-disclosure pwa-disclosure-card output-generation-disclosure", open: true, children: [_jsx("summary", { children: "Language and generation options" }), _jsxs("div", { className: "workspace-disclosure-body stack", children: [_jsxs("div", { className: "output-setting-row", children: [_jsx("strong", { children: "Output language" }), _jsx("span", { className: "muted", children: outputLanguageLabel })] }), _jsx("p", { className: "muted", children: "Desktop Notes currently follows the app-wide output language from Settings." }), _jsx("p", { className: "muted", children: "Select the sections you want in the generated output. Checked sections are included, and unchecked sections are left out." }), _jsx("div", { className: "output-section-grid", children: orderedSections.map((section) => {
                                                        ...
                                                        }) }), _jsxs("label", { className: "field config-field output-detail-field", children: [_jsx("span", { className: "field-label", children: "Detail level" }), _jsx("input", { id: "output-detail-level", type: "range", min: "1", max: "5", step: "1", value: String(session.detailLevel), onChange: (event) => onChange({ ...session, detailLevel: Number(event.target.value) }) }), _jsx("span", { className: "range-caption", children: session.detailLevel <= 1
                                                                    ? "Minimal detail"
